...
class FeedForwardNN:
    ...
    def forward(self, x):
        ...
        Args: x (ndarray): Input data of shape (batch_size, input_dim)
        Returns: ndarray: Output predictions of shape (batch_size, output_dim)
        """
        self.x = x
        self.z_values = []
        self.a_values = []
    ...
    def backward(self, d_loss):
        ...
        Args: d_loss (ndarray): Derivative of loss with respect to output
        """
    ...
    #Get all weights and biases i.e. returns:tuple: (weights, biases)
    ...
    # Get weight and bias gradients Returns:tuple: (dw, db)
